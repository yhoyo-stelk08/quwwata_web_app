import ProductDetailsReview from "./product-details/ProductDetailsReview";
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <div className="flex flex-col justify-center items-center w-full h-auto py-8 mt-10 border-b">
        {/* Header */}
        <h1 className="text-xl md:text-4xl text-slate-200 font-quicksand font-semibold italic tracking-wider">
          REVIEWS
        </h1>
      </div>
      <div className="w-full h-auto flex flex-col md:flex-row justify-center items-center border-b p-8">
        ...
        {reviewsData.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center">
            <h3 className="text-xl md:text-2xl text-slate-200 font-sans tracking-wider text-center">
