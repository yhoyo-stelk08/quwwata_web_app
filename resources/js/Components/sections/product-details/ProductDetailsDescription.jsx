const ProductDetailsDescription = () => {
  return (
    <div className="flex flex-col w-full h-full p-2 text-slate-200 xl:py-8 md:py-8 md:space-y-6 text-sm xl:text-base lg:text-base md:text-base text-left xl:text-left lg:text-center tracking-tight font-inter">
